...
def predict():
    ...
    if output == 0:
    	return render_template('index.html', prediction_text= 'Based on past placements data, this candidate WILL NOT be hired.',model_acc='(Note: Model accuracy - 89%)')
    else:
    	return render_template('index.html', prediction_text= 'Based on past placements data, this candidate WILL be hired.',model_acc='(Note: Model accuracy - 89%)')
